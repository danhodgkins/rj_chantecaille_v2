...
//remove to prevent the addition of the app group
   ...
   public class BuildPostProcessor
   {
      ...
      public static void OnPostProcessBuild(BuildTarget target, string path)
      {
        ...
        Debug.Log ("YOU ARE LOOKING FOR THIS: " + notificationServiceTarget);
        project.AddBuildProperty(notificationServiceTarget, "LIBRARY_SEARCH_PATHS", "$(PROJECT_DIR)/Libraries/OneSignal/Platforms/iOS");
    }
